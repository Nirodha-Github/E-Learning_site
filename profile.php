...
<html>
    ...
    <body>
      ...
      <div class="container">
        <div class="row">
        <form method="post"  class="card col-12 col-md-12 m-5 p-5">
           ...
           if(isset($_SESSION["success"])){
             ...
             <div class="col-12 col-md-3 order-md-first mr-5 offset-md">
              ...
              <div class="form-group row pic border border-secondary">
                   ...
                   <img src="image/profile_img" id="profile_pic" width="250"  >
              </div>
            ...
            <div class="col-12 col-md-8 order-md-last border-secondary border-left">        
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="firstname" class="form-control" value="" id="firstname"  placeholder="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="lastname" class="col-12 col-md-5 col-form-label">Last Name</label>
                        <div class="col-md-7">
                            <input type="text" name="lastname" class="form-control" value="" id="lastname"  placeholder=""></input>
                        </div>
                    </div> 
                    <div class="form-group row">
